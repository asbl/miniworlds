...
Die letzte if-Anweisung beinhaltet die Funktionalität. Das World wird gelöscht, es wird nach einer neuen Highscore gefragt die dann mit der Funktion `new_highscore` angezeigt wird.
