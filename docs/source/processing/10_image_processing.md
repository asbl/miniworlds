...
Im miniworlds können wir den `Hintergrund`  mit der Funktion 
...
Mit zunehmenden x-Wert steigt der x-Wert an. (x+1) / world.width ergibt einen Wert zwischen 0 und 1. 
