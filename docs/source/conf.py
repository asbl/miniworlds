...
htmlhelp_basename = 'miniworldsdoc'
html_theme_options = {
  "navbar_end": ["versions.html"]
}
...
latex_documents = [
    (master_doc, 'miniworlds.tex', 'miniworlds Documentation',
...
man_pages = [
    (master_doc, 'miniworlds', 'miniworlds Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'miniworlds', 'miniworlds Documentation',
     author, 'miniworlds', 'One line description of project.',
     'Miscellaneous'),
]
