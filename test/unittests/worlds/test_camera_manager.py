...
class TestCameraManager(unittest.TestCase):
    ...
    def test_should_repaint_actor_when_actor_was_visible_last_frame(self):
        self.mock_world.frame = 5
        mock_actor = Mock()
        mock_actor.position_manager.get_size.return_value = (10, 10)
        mock_actor.position_manager.position = (500, 500)
        mock_actor.position_manager.origin = "center"
        mock_actor.costume_manager.has_costume = False
        self.camera.view_actors_last_frame = {mock_actor}

        self.assertTrue(self.camera._should_repaint_actor(mock_actor))

    def test_should_repaint_actor_when_actor_enters_view(self):
        self.mock_world.frame = 5
        mock_actor = Mock()
        mock_actor.position_manager.get_size.return_value = (20, 20)
        mock_actor.position_manager.position = (50, 40)
        mock_actor.position_manager.origin = "center"
        mock_actor.costume_manager.has_costume = False
