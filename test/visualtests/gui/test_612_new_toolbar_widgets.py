from miniworlds import App, World, Toolbar, YesNoButton, Button
...
class TestToolbarYesNoWidget(unittest.TestCase):
    SCREENSHOT_TITLE = "Test612"
    ...
    def setUp(self):
        def test_code():
            ...
            def setup_environment(self, test):
                toolbar = Toolbar()
                world.camera.add_right(toolbar, size = 300)
